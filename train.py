...
# Import project modules explicitly so their MMEngine registries are populated.
for project_module in ("dataset", "evaluation", "hooks", "loss", "model"):
...
def parse_args():
    ...
    parser.add_argument("--load-from", type=str, help="checkpoint file")
    parser.add_argument(
